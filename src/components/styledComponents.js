...
export { 
    ...
    WrapperCart, TitleCart, ContentCart, Product, ProductDetail, ImageCart, Details, PriceDetail, ProductPrice, Top, TopButton, TopText, Bottom, Info1, Summary, SummaryTitle, SummaryItem
}